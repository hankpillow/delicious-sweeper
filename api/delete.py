...
class MainHandler(webapp.RequestHandler):
	...
	def post(self):
		...
		response = {}
		try:
			result = urlfetch.fetch(url=("https://api.del.icio.us/v1/posts/delete?url="+url),headers={"Authorization": "Basic %s" % encoded_credencial},deadline=60, allow_truncated=True)
